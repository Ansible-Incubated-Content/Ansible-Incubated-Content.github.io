...
This Ansible deployment example is implemented as an [Ansible collection][repo] in the Ansible Content Lab.  All of the details about the collection are available within the repository.
...
You must complete the following prior to running the deployment playbook in order to avoid any failures.
...
[repo]: https://github.com/ansible-content-lab/aws_ansible_deployment
